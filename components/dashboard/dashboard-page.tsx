    ...
    <main>
      ...
      <section className="bg-cream min-h-screen grid grid-cols-1 md:grid-cols-2 items-center px-6 md:px-40 pt-[120px] md:pt-[140px] pb-[60px] md:pb-20 gap-6 md:gap-12 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-lg leading-[1.65] text-slate max-w-[480px] mb-10">
            Drag, connect, and map relationships on an infinite canvas. Autosave
            locally and export your chart exactly as you built it.
          </p>
          ...
          <div>
            <div className="flex gap-4 items-center flex-wrap">
              ...
              >
                <span className="text-cream inherited-hover-state">
                  Start for Free
                </span>
                <svg
            ...
            <p className="mt-2.5 text-xs text-[#8a8a8a] flex items-center gap-[5px]">
              ...
              Google login is only used for cloud syncing & sharing — never for
              ads or tracking.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="text-center flex flex-col items-center mb-16">
            ...
            <p className="text-[17px] text-slate leading-[1.65] max-w-[700px]">
              Our app offers a smarter, faster, and more flexible way to create
              kinship charts with features designed for convenience,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate leading-[1.7]">
                  Create and edit kinship charts anytime, anywhere. Your work
            ...
            <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate leading-[1.7]">
                  Export your charts instantly for presentations, documentation,
            ...
            <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate leading-[1.7]">
                  Describe your family relationships in plain language, and the
                  AI will automatically generate the kinship chart for you — no
            ...
            <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate leading-[1.7]">
                  Assign Google accounts to specific family members or units in
                  the chart. Changes and shared diagrams can automatically
                  appear in the connected relative’s account.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate leading-[1.7]">
                  Enjoy a clean, responsive, and intuitive interface designed
                  for smooth navigation and effortless kinship mapping.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="text-center flex flex-col items-center mb-16">
            <h2 className="font-serif text-[clamp(32px,4vw,52px)] font-extrabold leading-[1.1] tracking-[-0.02em] mb-4">
              How <em className="italic text-gold font-semibold">Kinnect </em>{" "}
              Works
            </h2>
          </div>
      ...
      <div
        id="modal"
        className="hidden fixed inset-0 z-[1000] bg-black/60 backdrop-blur-sm items-center justify-center opacity-0 transition-opacity duration-200"
      >
        <div className="bg-white rounded-[20px] p-12 max-w-[420px] w-[90%] text-center shadow-[0_32px_80px_rgba(0,0,0,.2)] relative">
          <button className="absolute top-4 right-4 border-none bg-none text-xl cursor-pointer text-[#aaa] hover:text-ink transition-colors">
            ×
          </button>
          <div className="w-14 h-14 rounded-xl bg-cream flex items-center justify-center mx-auto mb-5 text-[26px]">
            🌳
          </div>
          <h3 className="font-serif text-[24px] mb-2 text-ink">
            Sign in to Kinship
          </h3>
          <p className="text-[14px] text-slate mb-7 leading-[1.6]">
            Google login enables cloud sync and sharing only — your diagrams
            remain private and are never shared with Google.
          </p>
