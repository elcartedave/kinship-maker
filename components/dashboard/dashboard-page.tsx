...
import { ChartDocumentPreview } from "@/components/dashboard/chart-document-preview";
...
export function DashboardPage({
  ...
  const deleteCandidate =
    charts.find((item) => item.id === deleteCandidateId) ?? null;
  ...
  async function handleDelete(id: string) {
    ...
    if (authEnabled && user && (!chart || chart.ownerId !== user.id)) {
      setDeleteError("Only the chart owner can delete this chart.");
      return;
    }
  ...
  return (
    <main>
      <ToastBridge message={toastMessage ?? null} clearSearchParam="toast" />

      <nav
        id="navbar"
        className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-6 md:px-40 py-4 md:py-5 bg-cream/85 backdrop-blur-md border-b border-gold/15 transition-all duration-300"
      >
          ...
          (user ? (
            <div className="flex text-sm items-center gap-6">
              ...
              <div className="flex flex-wrap gap-2">
                <Link
                  href="/profile"
                  className="px-[22px] py-2.5 rounded-lg bg-white text-ink text-sm font-medium cursor-pointer border border-warm tracking-wide transition-all duration-250 no-underline inline-flex items-center hover:border-gold hover:text-gold"
                >
                  Profile
                </Link>
                <button
            ...
            <ul className="hidden md:flex gap-8 list-none m-0 p-0">
              <li>
                <a
                  href="#features"
                  className="text-sm font-medium text-slate no-underline tracking-wide transition-colors duration-200 hover:text-gold"
                >
                  Features
                </a>
              </li>
      ...
      {!authEnabled || user ? (
        <section className="min-h-screen bg-cream relative overflow-hidden selection:bg-gold/20 px-6 md:px-40 pt-[100px] md:pt-[120px] pb-[60px] md:pb-20">
            ...
            <div className="relative z-10 mx-auto flex max-w-[1600px] flex-col justify-between gap-12 py-14 lg:flex-row lg:items-center">
              ...
              <div className="max-w-[620px]">
                ...
                <h1 className="font-serif text-[clamp(42px,5vw,72px)] font-black leading-[1.05] tracking-[-0.02em] mb-6">
                  Welcome back,{" "}
                  <em className="italic text-gold font-semibold">
                    {welcomeName}
                  </em>
                </h1>

                <p className="mt-6 max-w-[500px] text-lg md:text-[20px] leading-relaxed text-slate">
                  Continue building family diagrams, organizing generations, and
                  collaborating seamlessly across devices.
                </p>
              </div>
            ...
            <div className="mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate font-medium mt-3">
                  {charts.length + pendingInvitations.length} total items
                  available
                  {pendingInvitations.length > 0 &&
                    ` (${pendingInvitations.length} pending approval)`}
                </p>
              </div>
            ...
            {charts.length === 0 && pendingInvitations.length === 0 ? (
              ...
              <div className="rounded-[24px] border border-dashed border-warm bg-white p-12 md:p-20 text-center shadow-[0_4px_24px_rgba(15,14,13,0.02)]">
                ...
                <p className="mx-auto mt-3 max-w-md text-[17px] leading-[1.65] text-slate">
                  Create a clean chart or accept an authorization invitation to
                  populate your layout view.
                </p>
              </div>
            ) : (
              <div>
                {viewMode === "grid" ? (
                  ...
                  <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    {sortedCharts.map((chart) => {
                      ...
                      const canDelete =
                        !authEnabled ||
                        Boolean(user && chart.ownerId === user.id);
                      ...
                      return (
                        ...
                        >
                          <div>
                            <div className="mb-4">
                              <ChartDocumentPreview document={chart.document} />
                            </div>
                          ...
                          <div className="mt-6 flex items-center gap-3 border-t border-warm pt-4">
                            ...
                            {canDelete ? (
                              ...
                              >
                                {isDeleting ? (
                                  <svg
                                    className="animate-spin h-5 w-5 text-rust"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                  >
                                    <circle
                          ...
                          <div className="mt-4 sm:mt-0 flex items-center gap-2 sm:w-auto w-full">
                            ...
                            {canDelete ? (
                              ...
                              >
                                {isDeleting ? (
                                  <svg
                                    className="animate-spin h-4 w-4 text-rust"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                  >
                                    <circle
          ...
          <section
            className="bg-cream/40 px-6 md:px-12 py-16 md:py-24 border-t border-warm"
            id="team"
          >
            <div className="max-w-[1100px] mx-auto text-center">
              <div className="text-center flex flex-col items-center mb-16">
                <h2 className="font-serif text-[clamp(32px,4vw,52px)] font-extrabold leading-[1.1] tracking-[-0.02em] mb-4">
                  Meet the{" "}
                  <em className="italic text-gold font-semibold">Developers</em>
                </h2>
                <p className="text-[17px] text-slate leading-[1.65] max-w-[780px]">
                  We are a team of Computer Science students from the{" "}
                  <span className="font-semibold text-ink">
                    University of the Philippines Los Baños
                  </span>
                  , bridging technology and genealogy to build a smarter way to
                  connect.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white border border-warm rounded-2xl p-6 shadow-[0_4px_24px_rgba(15,14,13,0.02)] hover:border-gold/30 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center">
                  ...
                  <h3 className="font-sans font-bold text-[17px] text-ink mb-1">
                    Dave Andrie Elcarte
                  </h3>
        ...
        <>
          <section className="bg-cream min-h-screen grid grid-cols-1 md:grid-cols-2 items-center px-6 md:px-40 pt-[100px] md:pt-[120px] pb-[60px] md:pb-20 gap-6 md:gap-12 relative overflow-hidden">
            <div className="relative z-10">
              <h1 className="font-serif text-[clamp(42px,5vw,72px)] font-black leading-[1.05] tracking-[-0.02em] mb-6">
                ...
                <em className="italic text-gold font-semibold">Kinnect</em>
              </h1>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gold/12 border border-gold/30 text-s font-semibold text-gold tracking-[0.08em] uppercase mb-6">
                A SMART, AI-POWERED KINSHIP MAPPER
              </div>
              <p className="text-lg leading-[1.65] text-slate max-w-[480px] mb-10">
                Drag, connect, and map relationships on an infinite canvas.
                Autosave locally and export your chart exactly as you built it.
              </p>
              ...
              <div>
                ...
                <p className="mt-2.5 text-xs text-[#8a8a8a] flex items-center gap-[5px]">
                  ...
                  Google login is only used for cloud syncing & sharing — never
                  for ads or tracking.
                </p>
              </div>
            </div>
            ...
            <div className="relative hidden md:flex justify-center items-center z-10">
              <div className="bg-white border border-warm rounded-[20px] p-8 shadow-[0_24px_80px_rgba(0,0,0,.1),0_4px_16px_rgba(0,0,0,.06)] w-full max-w-[800px] relative animate-float">
                <Image
                  src={sampleImg}
                  alt="Kinnect Logo"
                  width={800}
            ...
            <div className="max-w-[1100px] mx-auto">
              ...
              <div className="text-center flex flex-col items-center mb-16">
                ...
                <p className="text-[17px] text-slate leading-[1.65] max-w-[700px]">
                  Our app offers a smarter, faster, and more flexible way to
                  create kinship charts with features designed for convenience,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    <div className="w-12 h-12 rounded-xl bg-cream flex items-center justify-center mb-5 text-[22px]">
                      <svg
                    ...
                    <h3 className="font-sans text-[20px] font-bold mb-3 text-ink">
                      Online & Offline Access
                    </h3>
                    <p className="text-sm text-slate leading-[1.7]">
                      Create and edit kinship charts anytime, anywhere. Your
                      work remains accessible even without an internet
                      connection.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-slate leading-[1.7]">
                      Export your charts instantly for presentations,
                      documentation, printing, or sharing with others.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative z-10">
                    <div className="w-12 h-12 rounded-xl bg-cream flex items-center justify-center mb-5 text-[22px]">
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-cable-icon lucide-cable"
                      >
                    ...
                    <p className="text-sm text-slate leading-[1.7]">
                      Describe your family relationships in plain language, and
                      the AI will automatically generate the kinship chart for
                      you — no manual setup required.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-slate leading-[1.7]">
                      Sign in with Google to securely sync your charts across
                      devices and continue your work anytime.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-slate leading-[1.7]">
                      Assign Google accounts to specific family members or units
                      in the chart. Changes and shared diagrams can
                      automatically appear in the connected relative’s account.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white border border-warm rounded-xl p-8 cursor-default relative overflow-hidden group hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,.08)] hover:border-gold/30 transition-all duration-300">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-slate leading-[1.7]">
                      Enjoy a clean, responsive, and intuitive interface
                      designed for smooth navigation and effortless kinship
                      mapping.
                    </p>
                  </div>
                </div>
          ...
          <section
            className="bg-ink text-cream px-4 md:px-12 py-16 md:py-[96px]"
            id="how"
          >
            <div className="max-w-[1100px] mx-auto">
              {/* Centered Header Section */}
              ...
              <div className="max-h-screen grid grid-cols-5 gap-0 overflow-x-auto md:overflow-visible">
                ...
                <div className="px-2 py-6 sm:px-4 md:p-8 border-r border-white/10 relative">
                  <div className="font-serif text-[28px] sm:text-[40px] md:text-[56px] font-black text-gold leading-none mb-4">
                    01
                  </div>
                  <h3 className="text-[13px] sm:text-[15px] md:text-[17px] font-semibold mb-2.5 text-cream">
                    Create Your Chart
                  </h3>
                  <p className="text-[11px] sm:text-xs md:text-sm text-cream/55 leading-[1.6]">
                    Start by dragging and placing family units onto the canvas.
                  </p>
                ...
                <div className="px-2 py-6 sm:px-4 md:p-8 border-r border-white/10 relative">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-cream/55 leading-[1.6]">
                    Draw connections between people to represent structures.
                  </p>
                  <div className="hidden md:block absolute top-[56px] right-[-20px] w-10 h-0.5 bg-gradient-to-r from-gold/40 to-transparent z-10"></div>
                </div>
                ...
                <div className="px-2 py-6 sm:px-4 md:p-8 border-r border-white/10 relative">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-cream/55 leading-[1.6]">
                    Describe relationships, and the AI will generate the chart.
                  </p>
                  <div className="hidden md:block absolute top-[56px] right-[-20px] w-10 h-0.5 bg-gradient-to-r from-gold/40 to-transparent z-10"></div>
                </div>
                ...
                <div className="px-2 py-6 sm:px-4 md:p-8 border-r border-white/10 relative">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-cream/55 leading-[1.6]">
                    Smart system automatically detects and labels roles.
                  </p>
                  <div className="hidden md:block absolute top-[56px] right-[-20px] w-10 h-0.5 bg-gradient-to-r from-gold/40 to-transparent z-10"></div>
                </div>
                ...
                <div className="px-2 py-6 sm:px-4 md:p-8 relative">
                  ...
                  <p className="text-[11px] sm:text-xs md:text-sm text-cream/55 leading-[1.6]">
                    Export your kinship chart as a PDF or PNG file.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="bg-ink text-cream px-6 md:px-12 py-20 md:py-[120px] text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="inline-block text-[12px] font-bold text-gold tracking-[0.1em] uppercase mb-5">
                Get started today
              </span>
              <h2 className="font-serif text-[clamp(36px,5vw,64px)] font-black leading-[1.05] mb-5">
                Ready to map your family's{" "}
                <em className="italic text-gold font-semibold">full story?</em>
              </h2>
              <p className="text-[17px] text-cream/60 mb-12">
                Free forever for single users. No credit card required.
              </p>
      ...
      {deleteCandidate ? (
        <DeleteConfirmationModal
          busy={busyAction === deleteCandidate.id}
          chartTitle={deleteCandidate.title}
          error={deleteError}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(24,18,10,0.35)] px-4">
      <section
        ...
        className="w-full max-w-md rounded-[1.75rem] border border-line bg-white p-6 shadow-[0_20px_60px_rgba(15,14,13,0.18)]"
      >
