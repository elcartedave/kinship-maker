      ...
      <section className="min-h-screen bg-cream relative overflow-hidden selection:bg-gold/20 px-6 md:px-40 pt-[100px] md:pt-[120px] pb-[60px] md:pb-20">
        ...
        <div className="border-b border-warm">
          <div className="relative z-10 mx-auto flex max-w-[1600px] flex-col justify-between gap-12 py-14 lg:flex-row lg:items-center">
            ...
            <div className="flex flex-wrap gap-3 sm:grid sm:grid-cols-3 lg:flex">
              {/* CREATE NEW CHART */}
              <button
                type="button"
                onClick={() => void handleCreateChart()}
                disabled={busyAction === "new"}
                className="group flex h-[112px] w-full sm:w-[128px] flex-col items-center justify-center rounded-[16px] bg-ink text-cream border-none transition-all duration-300 hover:-translate-y-1 hover:bg-gold hover:text-ink shadow-[0_3px_14px_rgba(15,14,13,.14)] hover:shadow-[0_6px_22px_rgba(201,147,58,.18)] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
              >
              ...
              <button
                ...
                className="group flex h-[112px] w-full sm:w-[128px] flex-col items-center justify-center rounded-[16px] border-[1.5px] border-warm bg-white text-ink shadow-[0_2px_10px_rgba(0,0,0,.04)] transition-all duration-300 hover:-translate-y-1 hover:border-gold hover:shadow-[0_4px_16px_rgba(0,0,0,.07)] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
              >
              ...
              {/* INSTALL APP */}
              <InstallButtonBig
                className="group flex h-[112px] w-full sm:w-[128px] flex-col items-center justify-center rounded-[16px] border-[1.5px] border-warm bg-white text-ink shadow-[0_2px_10px_rgba(0,0,0,.04)] transition-all duration-300 hover:-translate-y-1 hover:border-gold hover:shadow-[0_4px_16px_rgba(0,0,0,.07)] cursor-pointer"
              />
            </div>
          </div>
        </div>
